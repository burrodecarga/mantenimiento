...
<div class="container">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Permite importar datos desde un acrchivo excel llamado tipos.xlsx</p>
      <form action="{{route('tipos.importExcel')}} " method="POST" enctype="multipart/form-data">
           @method('POST');
            @csrf
...
<div class="card text-left">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Elimina todos los registros de tipos</p>
