        ...
        <div class="col-md-12 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="text-center mt-2 p-0 text-uppercase ">{{__('Asignación de Equipos para realizar tareas del plan de mantenimiento')}} </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th width="60%" class="text-capitalize">{{__('fecha')}}</th>
                                            ...
                                            <div class="collapse my-2" id="collapseDiario">
                                                <div class="card card-body">
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item">
                                                            <a class="btn btn-outline-success" href="{{route('teamplans.taskteam',$t->id)}}"
                                                            title="equipo de trabajo {{$t->team}}, responsable: {{$t->responsable}}">
                                                            {{$key+1}} - {{$t->tarea}}
                                                            @if($t->team_id<>0 AND $t->responsable_id<>0)
                                                            <i class="fa fa-address-book" aria-hidden="true"></i>
                                                            @endif
                                                            @if($t->resposable_id<=0 OR $t->team_id<>0)
